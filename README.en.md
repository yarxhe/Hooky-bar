...
Hooky bar is under active development. The current channel is **Beta 1**. Built-in features and internal adapters are stabilized; a public SDK for third-party integrations is planned after beta feedback.
